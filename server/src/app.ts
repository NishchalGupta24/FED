...
app.get('/api/sales', async (req, res) => res.json({ success: true, data: await SaleModel.find(scope(req)) }))
app.get('/api/ledger', async (req, res) => res.json({ success: true, data: await LedgerTransactionModel.find(scope(req)) }))
app.get('/api/payments', async (req, res) => res.json({ success: true, data: await PaymentModel.find(scope(req)) }))
